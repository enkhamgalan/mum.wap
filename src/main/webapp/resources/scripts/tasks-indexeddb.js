        ...
        initObjectStore: function (type, successCallback, errorCallback) {
            ...
            if (exists && exists1) {
                ...
                request.onupgradeneeded = function (event) {
                    ...
                    var objectStore = database.createObjectStore(tables[0], {keyPath: "id", autoIncrement: true});
                    var objectStore1 = database.createObjectStore(tables[1], {keyPath: "id", autoIncrement: true});
